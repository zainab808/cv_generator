...
'Built a performing learning app to sign up and earn by sharing their knowledge and skills and teacher/student dashboards.'
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text(' SKILLS', style: titleStyle),
                    pw.SizedBox(height: 3),
                    pw.Container(
                      height: 2.5,
                      width: 35,
  ...
  pw.Padding(
    ...
    child: pw.Column(
      ...
      children: [
        ...
        if (e['details'] != null && (e['details'] as String).trim().isNotEmpty)
          pw.Column(
            crossAxisAlignment: pw.CrossAxisAlignment.start,
            children: (e['details'] as String)
...
for (var e in experience2)
                 ...
                 pw.Text(
                  ...
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text(
                        '- Provider, Riverpod, BLoC, GetX, Cubit',
                        style: pw.TextStyle(fontSize: 12),
                      ),
                    ],
                  ),
  ...
  color: PdfColors.black,
          ...
          pw.Expanded(
            child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
              pw.Text('Projects', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 18,  color: PdfColors.black,)),
           ...
           for (var p in projects)
             ...
             pw.SizedBox(height:  3),
                    ...
                    pw.Text(' ${p['tag']}', style:  pw.TextStyle(fontSize: 9,fontWeight: pw.FontWeight.bold)),
          ...
          pw.Expanded(
            child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
              ...
              for (var P in projects2)
                  ...
                  padding: const pw.EdgeInsets.only(top: 6),
                  child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                    pw.Text(P['title'] ?? '', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 12)),
