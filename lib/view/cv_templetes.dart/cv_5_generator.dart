...
class _Resume5ScreenState extends State<Resume5Screen> {
  ...
  final education = [
    {
      ...
      'details': [
        ...
        'Completed final year project focused on cross-platform app development .',
    ...
    },
    {
      ...
      'details': [
        'Focused on mathematics and computer science foundations.',
        'Built problem-solving base that contributed to software development skills.',
      ],
    },
    {
      'degree': 'Matriculation (Science)',
  ...
  final List<Map<String, String>> projects3 = [
    {
      'title': 'Certainli.se',
      'subtitle':
          'A web platform specializing in modern electronic components and product lifecycle management.',
