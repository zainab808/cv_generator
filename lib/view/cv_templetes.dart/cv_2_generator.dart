...
''';
  ...
  final List<Map<String, String>> experiences2 = [
   ...
   final List<Map<String, String>> experiences3 = [
   
    {
      'role': 'CTO & FlutterFlow Developer _ OnPio',
    ...
    {
      'role': 'CTO & Flutter Developer _ JoinCircleUp',
  ...
  final List<Map<String, String>> projects = [
    ...
    {
      'title': 'Fittechn',
      'tag': 'Complete Flutter App',
      'desc':
          'Fittechn provides Arabic and Spanish speakers a fitness-oriented application focusing on daily workouts, calorie tracking, and nutrition. Developed entirely with a focus on Spanish-language users.',
    },
    {
      'title': 'AirMoneRestaurant',
      'tag': 'Complete Flutter Application',
      'desc':
          'AirMoneRestaurant app is a specialized application catering to a specific restaurants ordering and delivery system, along with an authentic point-based membership reward system.',
    },
    {
      'title': 'IQRA Quran App',
      'tag': 'Complete Flutter Application',
      'desc':
          'IQRA is a Quran app offering features like Quranic content, prayer times, daily Duas, and an offline reading mode. Designed for Muslims seeking Quranic guidance and Islamic practices.',
    },
    {
      'title': 'Reverse Disease',
      'tag': 'FlutterFlow Application',
      'desc':
          'Reverse Disease is a health tracking app that monitors fatigue, sugar, weight, and nutrition, providing a comprehensive tool for users aiming to improve their health and lifestyle.',
    },
    {
      'title': 'Amici',
      'tag': 'Complete Flutter App',
      'desc':
          'Amici App is designed to streamline the process of booking a chef for entire events and gatherings.',
    },
    {
      'title': 'United Proposal',
      'tag': 'FlutterFlow Application',
      'desc':
          'United Proposal is a matrimonial matching platform facilitating the search for suitable life partners through detailed algorithms and AI-based compatibility results. The app includes an integrated chat system, premium subscription model, and an admin dashboard for content control. ',
    },
    {
      'title': 'PricePro',
      'tag': 'Complete Flutter App',
      'desc':
          'Application for managing menus of different branches of restaurants. Copy and sync features for branches and add different taxes. ',
    },
    {
      'title': 'MyCash',
      'tag': 'Complete Flutter App',
      'desc':
          'MyCash App is a home-run application designed to provide easy and transparent record-keeping for small business owners and individuals. ',
    },
    {
      'title': 'Flavourz Restaurant',
      'tag': 'Complete Flutter App',
      'desc':
          'Flavourz is a dedicated food application tailored for a specific restaurant, implementing ordering and specialized platform for customers to place orders. ',
    },
  ];
  final List<Map<String, String>> projects2 = [
    {
      ...
      'tag': 'Complete Flutter App',
      'desc':
          'OnFekwa is a social media app designed to help users discover the best lifestyle trends. It focuses on building fun, supportive communities based on hobbies and interests. The app includes story uploading, follower/following, messaging, and sharing features, bringing local discovery to life.',
    },
    {
      'title': 'Hikary',
      'tag': 'Complete Flutter App',
      'desc':
          'Hikary is a news and information app helping users stay informed with current, verified information. It features an AI-based recommendation system, content filtering, and user engagement through interactive discussions.',
    },
    {
      'title': 'YobleMane',
      'tag': 'Complete Flutter App',
      'desc':
          'YobleMane is an online dining app that connects customers with diners for customized meal selection and food discovery. Exceptionally functional, it provides easy ordering, menus, and food availability through the app.',
    },
    {
      'title': 'Muttaqi Quran App',
      'tag': 'Complete Flutter App',
      'desc':
          'Muttaqi Quran App is a digital Quran application serving a larger and growing Muslim community. The app provides Quran reading, tafseer, and prayer notifications with Arabic audio playback for improved accessibility.',
    },
    {
      'title': 'Bissi Player',
      'tag': 'Complete Flutter App',
      'desc':
          'Bissi Player is an AI-driven streaming app that allows users to watch movies and music videos through Flutter-based smooth integration. It features smart search, trending recommendations, and card-based interface for easy access.',
    },
    {
      'title': 'Kamacee',
      'tag': 'Complete Flutter App',
      'desc':
          'Kamacee is a local African online marketplace app, inspired by platforms like Amazon and Jumia. It provides multi-vendor shopping, delivery status tracking, and rating systems for both sellers and buyers, ensuring safe and reliable transactions.',
    },
    {
      'title': 'WirdBook',
      'tag': 'Complete Flutter App',
      'desc':
          'The WirdBook is a spiritual guide for all-day litanies rooted in Prophetic traditions. Designed by Sufi tech engineers, it serves as an all-in-one platform for learning, practicing, and managing daily Wirds, ensuring users remain consistent with their prayers and remembrance.',
    },
    {
      'title': 'WeTeachs',
      'tag': 'Complete Flutter Application',
      'desc':
          'Learn and earn by sharing your knowledge_any skill you learned could help others! The WeTeachs app allows users to teach, learn, and earn in one platform, providing practical guidance for tutors to grow their digital reach.',
    },
    {
      'title': 'Nubes App',
      'tag': 'Complete Flutter Application',
      'desc':
          'A seamless platform to purchase clothes, online accessories, and personal items designed for both small-scale eCommerce and global marketplaces.',
    },
    {
      'title': 'OnPilo',
      'tag': 'Complete Flutter App',
      'desc':
          'OnPilo is a digital learning platform designed to keep user data and activities secure through AI-based tracking and gamified learning systems. It includes a course management dashboard, building a sustainable student-centered model.',
    },
    {
      'title': 'Umazing',
      'tag': 'Complete Flutter App',
      'desc':
          'Umazing is a multi-functional eCommerce app built to provide users with a platform to buy and sell all categories of goods, products, and services online. The app includes AI recommendation systems, chat features, and advanced search options.',
    },
    {
      'title': 'Visual Fraction Calculator',
      'tag': 'Complete Flutter App',
      'desc':
          'Visual Fraction Calculator is a mobile app designed to make fraction calculation interactive and easy. It includes drag-and-drop visual representation of fractions and converts between forms, serving as a digital educational tool for students. ',
    },
  ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'LinkedIn: linkedin.com/in/arham-sarwar',
            style: TextStyle(color: Colors.white70),
          ),
          ...
          pw.Center(
            child: pw.Container(
              ...
              child: pw.Center(
                child: pw.Text(
                  'AS',
                  style: pw.TextStyle(color: PdfColor.fromHex('#0C6A57')),
                ),
              ),
            ),
          ),
                ...
                children: [
                  ...
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text(
                        '- Jira, Trello, ClickUp, Agile/Scrum',
                        style: pw.TextStyle(fontSize: 12),
                      ),
                    ],
                  ),
                  ...
                  //  pw.Row(children: [
                  //  pw.Bullet(text: " Flutter and Dart",style: pw.TextStyle(fontSize: 10,fontWeight: pw.FontWeight.bold)),
                  // //  pw.Text("_ ")
                  //  ])
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [_buildLeftColumn(context), _buildRightColumn(context)],
      ),
    );
  }
}
